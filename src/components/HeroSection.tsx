        ...
        >
          <div className="w-full md:w-1/2 text-left">
            ...
            >
              ...
              >
                <div className="absolute -inset-2 rounded-lg blur opacity-0 group-hover:opacity-100 transition duration-500"
                  style={{ background: `linear-gradient(135deg, ${themeColors.gradientStart}, ${themeColors.gradientEnd})` }}></div>
                <div className="relative px-6 py-3 rounded-lg text-white transition-colors duration-300 ring-1 ring-opacity-30"
                  style={{ 
