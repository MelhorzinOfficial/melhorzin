                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="w-full md:w-1/2">
                    ...
                    <div className="mt-8 grid grid-cols-2 gap-4">
                      <div className="p-4 rounded-lg" style={{ backgroundColor: themeColors.cardBackground, color: themeColors.text }}>
              ...
              <Section id="habilidades" title={t('skills.title')}>
                <div className="max-w-4xl mx-auto">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    {/* Back End */}
                    <div className="p-6 rounded-lg text-center" style={{ backgroundColor: themeColors.cardBackground, color: themeColors.text }}>
                ...
                <div className="max-w-2xl mx-auto">
                  ...
                  <div className="flex justify-center space-x-8">
                    <a 
                      ...
                      style={{ backgroundColor: themeColors.cardBackground, color: themeColors.text }}
                    >
